...
RSpec.describe 'bin/map_inp', :compare_files, type: :acceptance_test do
  # context 'help' do
  #   it 'nice error message' do
  #     expect(1).to eq(2), 'error'
  #   end
  # end
  ...
  context 'with filter' do
    ...
    it 'can also output capture groups' do
      ...
      expect(output).to be_same_lines(expected_output)
    end
